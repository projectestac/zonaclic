...
a la Franja Oriental d'Arag&oacute;.</span></p>
			 ...
			 <tr class="ocult">
			    <td align="left" valign="middle"><p><a href="<%=b.getServerBaseUrl()%>/gali.jsp?var=alg"><img src="imatges/selecciona.gif" alt="Variant algueresa" width="68" height="45" vspace="5" border="0"></a></p>
		        </td>
                <td valign="middle" width="88%" class="cos"> 
