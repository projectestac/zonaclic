...
public class JSONArray {
  ...
  public JSONArray put(double value) throws JSONException {
    values.add(new Double(JSON.checkDouble(value)));
    return this;
  }
   ...
   * Appends {@code value} to the end of this array.
   *
   * @param value a {@link JSONObject}, {@link JSONArray}, {@link Collection},
   * String, Boolean, Integer, Long, Double, {@link JSONObject#NULL}, or
   * {@code null}. May not be {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
   *     infinities}. Unsupported values are not permitted and will cause the array
  ...
  public JSONArray put(int index, double value) throws JSONException {
    return put(index, new Double(value));
  }
   ...
   * that value is the {@code null} reference. This method returns normally if
   * the value is {@code JSONObject#NULL}.
   */
   ...
   * @param index
   * @return 
   * @throws JSONException if the value at {@code index} doesn't exist or cannot
  ...
  public boolean getBoolean(int index) throws JSONException {
    ...
    if (result == null) {
      throw JSON.typeMismatch(new Integer(index), object, "boolean");
    }
  ...
  public double getDouble(int index) throws JSONException {
    ...
    if (result == null) {
      throw JSON.typeMismatch(new Integer(index), object, "double");
    }
  ...
  public int getInt(int index) throws JSONException {
    ...
    if (result == null) {
      throw JSON.typeMismatch(new Integer(index), object, "int");
    }
   ...
   * @return 
   * @throws JSONException if the value at {@code index} doesn't exist or cannot
   * be coerced to a long.
   */
  public long getLong(int index) throws JSONException {
    Object object = get(index);
    Long result = JSON.toLong(object);
    if (result == null) {
      throw JSON.typeMismatch(new Integer(index), object, "long");
    }
  ...
  public String getString(int index) throws JSONException {
    ...
    if (result == null) {
      throw JSON.typeMismatch(new Integer(index), object, "String");
    }
    return result;
  }
  ...
  /**
   * Returns the value at {@code index} if it exists, coercing it if necessary.
   * Returns {@code fallback} if no such value exists.
   * @param index
   * @param fallback
   * @return 
   */
  ...
  public JSONArray getJSONArray(int index) throws JSONException {
    ...
    if (object instanceof JSONArray) {
      ...
      throw JSON.typeMismatch(new Integer(index), object, "JSONArray");
    }
  }
  ...
  public JSONObject getJSONObject(int index) throws JSONException {
    ...
    if (object instanceof JSONObject) {
      ...
      throw JSON.typeMismatch(new Integer(index), object, "JSONObject");
    }
  }
