...
public class JSONObject {
  ...
  private static final Double NEGATIVE_ZERO = new Double(-0d);
  ...
  public JSONObject(Map copyFrom) {
    ...
    Iterator it = contentsTyped.entrySet().iterator();
    while (it.hasNext()) {
  ...
  public JSONObject put(String name, boolean value) throws JSONException {
    nameValuePairs.put(checkName(name), Boolean.valueOf(value));
    return this;
  }
  ...
  public JSONObject put(String name, double value) throws JSONException {
    nameValuePairs.put(checkName(name), new Double(JSON.checkDouble(value)));
    return this;
  }
  ...
  public JSONObject put(String name, int value) throws JSONException {
    nameValuePairs.put(checkName(name), new Integer(value));
    return this;
  }
  ...
  public JSONObject put(String name, long value) throws JSONException {
    nameValuePairs.put(checkName(name), new Long(value));
    return this;
  }
   ...
   * mapping exists but its value is not an array, the existing and new values
   * are inserted in order into a new array which is itself mapped to
   * {@code name}. In aggregate, this allows values to be added to a mapping one
   * at a time.
   *
   * <p>
  ...
  /**
   * Returns true if this object has a mapping for {@code name}. The mapping may
   * be {@link #NULL}.
   *
   * @param name
   * @return
  ...
  /**
   * Returns the value mapped by {@code name} if it exists and is an int or can
   * be coerced to an int, or throws otherwise.
   *
   * @param name
   * @return
   * @throws JSONException if the mapping doesn't exist or cannot be coerced to
  ...
  /**
   * Returns the value mapped by {@code name} if it exists and is an int or can
   * be coerced to an int, or 0 otherwise.
   *
   * @param name
   * @return
   */
  ...
  /**
   * Returns the value mapped by {@code name} if it exists and is an int or can
   * be coerced to an int, or {@code fallback} otherwise.
   *
   * @param name
   * @param fallback
   * @return
  ...
  /**
   * Returns the value mapped by {@code name} if it exists and is a long or can
   * be coerced to a long, or throws otherwise. Note that JSON represents
  ...
  /**
   * Returns the value mapped by {@code name} if it exists and is a long or can
   * be coerced to a long, or 0 otherwise. Note that JSON represents numbers as
   * doubles, so this is <a href="#lossy">lossy</a>; use strings to transfer
   * numbers via JSON.
   *
   * @param name
   * @return
  ...
  /**
   * Returns the value mapped by {@code name} if it exists and is a long or can
   * be coerced to a long, or {@code fallback} otherwise. Note that JSON
  ...
  /**
   * Returns an array with the values corresponding to {@code names}. The array
   * contains null for names that aren't mapped. This method returns null if
   * {@code names} is either null or empty.
   *
   * @param names
   * @return
   * @throws org.json.JSONException
  ...
  /**
   * Returns the set of {@code String} names in this object. The returned set is
   * a view of the keys in this object. {@link Set#remove(Object)} will remove
   * the corresponding mapping from this object and set iterator behaviour is
  ...
  void writeTo(JSONStringer stringer) throws JSONException {
    ...
    Iterator it = nameValuePairs.entrySet().iterator();
    while (it.hasNext()) {
      Map.Entry entry = (Map.Entry) it.next();
  ...
  public static String quote(String data) {
    ...
    try {
      JSONStringer stringer = new JSONStringer();
      stringer.open(JSONStringer.NULL, "");
      stringer.value(data);
      stringer.close(JSONStringer.NULL, JSONStringer.NULL, "");
      return stringer.toString();
    } catch (JSONException e) {
   ...
   * object is {@code NULL}, no wrapping is necessary. If the object is an array
   * or {@code Collection}, returns an equivalent {@code JSONArray}. If the
   * object is a {@code Map}, returns an equivalent {@code JSONObject}. If the
   * object is a primitive wrapper type or {@code String}, returns the object.
   * Otherwise if the object is from a {@code java} package, returns the result
   * of {@code toString}. If wrapping fails, returns null.
   *
   * @param o
   * @return
   */
