...
public abstract class Utilities {
  ...
  static public String getParam(HttpServletRequest request, String key, String defaultValue) {
  ...
  static public boolean getBoolParam(HttpServletRequest request, String key, boolean defaultValue) {
    String result = request.getParameter(key);
    if (result == null || result.length() == 0) {
      result = defaultValue ? PageBean.TRUE : "";
    }
    return result.equals(PageBean.TRUE);
  }

  static public String enumItems(String[] text) {
    String result = "";
    StringBuffer sb = new StringBuffer();
  ...
  static public String enumItems(TableWrapper[] tw) {
    String result = "";
    StringBuffer sb = new StringBuffer();
