...
<title>zonaClic - Canal RSS de noticias</title>
<!-- InstanceEndEditable --> 
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link href="../css/basic.css" rel="stylesheet" type="text/css">
<script language="JavaScript" src="../scripts/mm.js" type="text/JavaScript"></script>
<!-- InstanceBeginEditable name="head" -->
<link rel="alternate" title="zonaClic" href="<%=appBase%>/rss_es.xml" type="application/rss+xml">
 ...
 <table border="0" width="758" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <td class="main" width="718" valign="top"><script language="JavaScript" src="../scripts/av_es.js" type="text/JavaScript"></script><!-- InstanceBeginEditable name="zona0" --> 
        <p class="topMenu"><a href="../es/index.htm">inicio</a> | <a href="../es/com/index.htm">comunidad</a> 
          | rss</p>
        <p class="t1">Canal RSS de noticias</p>
        <p><a type="application/rss+xml" href="<%=appBase%>/rss_es.xml"><img src="../img/xml.gif" alt="Canal RSS de not&iacute;cies de la zonaClic" border="0"></a></p>
        <p>El <a href="<%=appBase%>/rss_es.xml">canal RSS</a> de la
          <strong>zonaClic</strong> ofrece informaci&oacute;n actualizada sobre 
          las novedades que se van produciendo en la web. Se puede consultar directamente 
          desde esta p&aacute;gina o mediante cualquier programa capaz de leer 
          documentos RSS. Hay dos tipos de lectores RSS: los que se instalan en el PC, como <a href="http://www.mozilla.org/thunderbird" target="_blank" class="extern">Thunderbird</a> o <a href="http://www.mozilla.org/products/firefox/" target="_blank" class="extern">Firefox</a>, y servicios en l&iacute;nea como <em>Google</em>, <em>Bloglines</em>, <em>NewsGator</em> o <em>MyYahoo!</em>. Para a&ntilde;adir el canal <strong>zonaClic</strong> a uno de estos servicios haz clic en el bot&oacute;n correspondiente:</p>
        <p align="center"><a href="http://fusion.google.com/add?feedurl=<%=appBase%>/rss_es.xml"><img src="../img/add-to-google-plus.gif" alt="Afegir la zonaClic al Google Reader" width="104" height="17" hspace="10" border="0" align="absmiddle"></a><a href="http://www.bloglines.com/sub/<%=appBase%>/rss_es.xml"><img src="../img/add-to-bloglines.gif" alt="Afegir la zonaClic al Bloglines" width="76" height="17" hspace="10" border="0" align="absmiddle"></a><a href="http://www.newsgator.com/ngs/subscriber/subext.aspx?url=<%=appBase%>/rss_es.xml"><img src="../img/newnewsgator_button.gif" alt="Afegir la zonaClic al NewsGator" width="91" height="17" hspace="10" border="0" align="absmiddle"></a><a href="http://add.my.yahoo.com/content?url=http%3A//clic.xtec.cat/db/rss_es.xml"><img src="../img/addtomyyahoo.gif" alt="Afegir la zonaClic al My Yahoo!" width="91" height="17" hspace="10" border="0" align="absmiddle"></a></p>
        <% if(b.rss==null || b.rss.length==0){
%>
        <p>No hay ninguna noticia!</p>
        <%} else {
