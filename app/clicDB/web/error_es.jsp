...
<html><!-- InstanceBegin template="/Templates/basic_es.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<% }%>
<h2>ERROR</h2>
<p>¡Se ha producido un error en el servidor!</p>
<%String err=(String)request.getAttribute("ERROR");
if(err!=null && err.length()>0){%><%=err%><%}%>
        <p><a href="../es/act/index.htm">[volver]</a></p>
        <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="addThis" --><!-- InstanceEndEditable --></td>
