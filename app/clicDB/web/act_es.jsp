...
<html><!-- InstanceBegin template="/Templates/act_es.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div align="center"> 
 <table border="0" width="758" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <td class="main" width="718" valign="top"><script language="JavaScript" src="https://clic.xtec.cat/scripts/av_es.js" type="text/JavaScript"></script>
...
<% }%>
        <div class="topMenu"><a href="../es/index.htm">inicio</a> | <a href="../es/act/index.htm">actividades</a> 
          | <a href="listact_es.jsp"><strong>b&uacute;squeda</strong></a> 
        </div>
  ...
  <tr> 
   ...
   <td class="f1" width="718" valign="top">
    <table border="0" cellspacing="0" cellpadding="3" width="718" class="f1">
	 ...
	 <tr>
	        <td width="42%" rowspan="2" valign="top" class="f1"><a href="../es/jclic/howto.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('info<%=i%>1','','../img/info_on.gif',1)"><img src="../img/info.gif" alt="" name="info<%=i%>1" width="20" height="20" hspace="3" border="0" align="absmiddle" id="info<%=i%>1">&iquest;c&oacute;mo 
              funciona?</a><br>
...
<strong><%=b.getMsg("newTag")%></strong> <a href="https://clic.xtec.cat/repo/index.html?lang=es&prj=<%=v.getFolderBase()%>"><%=b.getMsg("newLib")%></a>
  ...
  <tr>
   ...
   <td class="f2" width="718" valign="top">
	<table border="0" cellspacing="0" cellpadding="3" width="718" class="f2">
	 ...
	 <tr>
	        <td width="55%" rowspan="2" valign="top" class="f2"><a href="../es/clic3/howto.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('info<%=i%>','','../img/info_on.gif',1)"><img src="../img/info.gif" alt="" name="info<%=i%>" width="20" height="20" hspace="3" border="0" align="absmiddle">&iquest;c&oacute;mo 
              funciona?</a><br>
<%     int tipus=-1;
       int cnt=0;
