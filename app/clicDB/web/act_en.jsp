...
<html><!-- InstanceBegin template="/Templates/act_en.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
<head>
...
<% }%>         
        <div class="topMenu"><a href="../en/index.htm">home</a> | <a href="../en/act/index.htm">activities</a> 
          | <a href="listact_en.jsp"><strong>search</strong></a> </div>
  ...
  <tr>
   ...
   <td class="f2" width="718" valign="top">
	<table border="0" cellspacing="0" cellpadding="3" width="718" class="f2">
	 ...
	 <tr>
	        <td width="55%" rowspan="2" valign="top" class="f2"><a href="../en/clic3/howto.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('info<%=i%>','','../img/info_on.gif',1)"><img src="../img/info.gif" alt="" name="info<%=i%>" width="20" height="20" hspace="3" border="0" align="absmiddle">how 
              does it work?</a><br>
<%     int tipus=-1;
       int cnt=0;
